...
public class ShortestPathDAcyclic 
{
         ...
         while (stack.empty() == false)
         {
             ...
             if (dist[u] != INF)
             {
                 ...
                 while (it.hasNext())
                 {
                     ...
                     System.out.print(",(v="+i.getV()+ ",u="+u+"),dv=" +dist[i.getV()] );
                     System.out.print( ",du="+dist[u] + "+w="+i.getWeight() );
                 }
             }
         }
 ...
 public static void main(String args[])
 {
     ...
     // 0=r, 1=s, 2=t, 3=x, 4=y, 5=z
	  ShortestPathDAcyclic  t = new ShortestPathDAcyclic();
