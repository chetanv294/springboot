...
import net.spring.auction.AuctionInfo;
...
public class Main {
	...
	public void viewAllAuctionsFast() throws Exception {
		...
		Test test = new Test();
		Session s = test.getCurrentSession();
		try {
	 ...
	 */
	public void viewUserAuctions(int sellerId) throws Exception {
	...
	//	Transaction tx = s.beginTransaction();
		...
		seller.setFirstName("Max");seller.setInitial('R');seller.setFirstName( "Andersen") ;
		...
		bidder1.setFirstName("Gavin");bidder1.setInitial('R');bidder1.setFirstName( "King") ;
		...
		bidder2.setFirstName("Steve");bidder2.setInitial('R');bidder2.setFirstName( "Ebersole") ;
